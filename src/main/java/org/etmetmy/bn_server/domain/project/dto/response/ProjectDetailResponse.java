    ...
    public static class Converter {
        public static ProjectDetailResponse from(Project project, Memo projectMemo, Memo userMemo) {
            return ProjectDetailResponse.builder()
                    ...
                    .projectMemoId(projectMemo != null ? projectMemo.getMemoId() : null)
                    .projectMemoContent(projectMemo != null ? projectMemo.getContent() : null)
                    .userMemoId(userMemo != null ? userMemo.getMemoId() : null)
                    .userMemoContent(userMemo != null ? userMemo.getContent() : null)
