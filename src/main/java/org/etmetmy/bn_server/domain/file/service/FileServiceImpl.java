...
public class FileServiceImpl implements FileService {
    ...
    public Page<FileTrashResponse> getDeletedFilesWithSearch(
            Long loginUserId,
            Long projectId,
            String keyword,
            Pageable pageable) {
        ...
        // 검색 + 페이지네이션 조회
        Page<File> deletedFilesPage = fileRepository.findDeletedFilesByProjectIdWithSearch(projectId, keyword, pageable);

        // Entity -> DTO 변환
        return deletedFilesPage.map(FileTrashResponse.Converter::from);
    }
